...
3. Name your Virtual Machine **pi-hole**. <br>To qualify for the Free Tier, your Region selection should be any US region only (excluding Northern Virginia [us-east4]). I have used **us-east1** and the **us-east1-b** zone because it is closest to me. <br>Choose a **micro** Machine Type in the dropdown. <br>You must **Change** the operating system and select **Ubuntu** in the Operating System dropdown, and choose **Ubuntu 20.04 LTS Minimal** under the Version dropdown. <br>Change the Boot Disk Size to be **30GB** if you plan on keeping your DNS lookup records for any reason, otherwise the default **10GB** disk allocation is adequate.
